...
def get_ucb_action(mean_reward_per_bandit, c, n, action_count_per_bandit):
    ...
    :param action_count_per_bandit: Number of time the bandit arm is selected
    :return: returns the action as per upper confidence bound equation
    """
    # Implement action selection by upper confidence bound equation
