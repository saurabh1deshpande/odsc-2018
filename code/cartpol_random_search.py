...
def random_search():
    """
    This function returns CartPole-v1 parameters using random search
    CartPole-v1 Parameters - 4 Parameter between [-1,1]
    For more information regarding the meaning of each parameter,
    please check https://github.com/openai/gym/wiki/CartPole-v0

    :return: NumPy array of length 4 with random numbers between [-1,1]
    """
